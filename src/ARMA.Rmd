...
# Plot 1 (In-sample prediction)
plot(t, data$CPIAUCSL_PC1, col="black", ylab="mu_t", type="l",
     main="Data (Black) vs In-sample preditction (Red)")
points(tt, yp,pch="*", col="red")
polygon(c(tt, rev(tt)), c(q1, rev(q2)), col = rgb(1, 0, 0, 0.3), border = NA)

# Plot 2 (Out-of-sample prediction)
plot(t, data$CPIAUCSL_PC1, col="black", ylab="mu_t", ylim=c(min(q1_pred),max(q2_pred)),
     type="l", main= "Out-of-sample prediction (Blue)")
points(tt, yp, pch="*", col="red")
polygon(c(tt, rev(tt)), c(q1, rev(q2)), col = rgb(1, 0, 0, 0.3), border = NA)
