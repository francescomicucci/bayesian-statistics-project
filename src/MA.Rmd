...
outputmcmcAR_GDP <- jags(model.file = textConnection(modelMA_q2.string),
                         data = line_data_GDP,
...
outputmcmcAR_CPIAUCSL <- jags(model.file = textConnection(modelMA_q2.string),
                              data = line_data_CPIAUCSL,
                              parameters.to.save= c("theta_1", "theta_2", "sigma2", "eps", "m0", "Yp", "ypOut"), 
                              n.adapt=1000, n.iter=10000, n.chains = 3, n.burnin = 3000)
```
...
```{r}
mcmc_trace(outputmcmcAR_GDP$samples, pars = c("theta_1"))
mcmc_areas(outputmcmcAR_GDP$samples, pars = c("theta_1"),  prob = 0.95)
mcmc_trace(outputmcmcAR_GDP$samples, pars = c("theta_2"))
mcmc_areas(outputmcmcAR_GDP$samples, pars = c("theta_2"),  prob = 0.95)
mcmc_trace(outputmcmcAR_GDP$samples, pars = c("sigma2"))
mcmc_areas(outputmcmcAR_GDP$samples, pars = c("sigma2"),  prob = 0.95)

autocorr.plot(outputmcmcAR_GDP$samples[,c("theta_1")],main="theta 1 GDP")
autocorr.plot(outputmcmcAR_GDP$samples[,c("sigma2")],main="sigma2 GDP")
autocorr.plot(outputmcmcAR_GDP$samples[,c("theta_2")],main="theta 2 GDP")

mcmc_trace(outputmcmcAR_CPIAUCSL$samples, pars = c("theta_1"))
mcmc_areas(outputmcmcAR_CPIAUCSL$samples, pars = c("theta_1"),  prob = 0.95)
mcmc_trace(outputmcmcAR_CPIAUCSL$samples, pars = c("theta_2"))
mcmc_areas(outputmcmcAR_CPIAUCSL$samples, pars = c("theta_2"),  prob = 0.95)
mcmc_trace(outputmcmcAR_CPIAUCSL$samples, pars = c("sigma2"))
mcmc_areas(outputmcmcAR_CPIAUCSL$samples, pars = c("sigma2"),  prob = 0.95)

autocorr.plot(outputmcmcAR_CPIAUCSL$samples[,c("theta_1")],main="theta CPIAUCSL")
autocorr.plot(outputmcmcAR_CPIAUCSL$samples[,c("theta_2")],main="theta CPIAUCSL")
autocorr.plot(outputmcmcAR_CPIAUCSL$samples[,c("sigma2")],main="sigma2 CPIAUCSL")
```
...
theta.mcmc.mat=as.matrix(outputmcmcAR_GDP$samples[,c("theta_1")], iters = FALSE)
ytheta=kdensity(theta.mcmc.mat)
plot(ytheta,main="posterior of theta 1")
abline(v=MA_gdp_q2$coef[1],col="green")
abline(v=outputmcmcAR_GDP$mean$theta_1,col="blue")

theta.mcmc.mat=as.matrix(outputmcmcAR_GDP$samples[,c("theta_2")], iters = FALSE)
ytheta=kdensity(theta.mcmc.mat)
plot(ytheta,main="posterior of theta 2")
abline(v=MA_gdp_q2$coef[2],col="green")
abline(v=outputmcmcAR_GDP$mean$theta_2,col="blue")
```
...
theta.mcmc.mat=as.matrix(outputmcmcAR_CPIAUCSL$samples[,c("theta_1")], iters = FALSE)
ytheta=kdensity(theta.mcmc.mat)
plot(ytheta,main="posterior of theta 1")
abline(v=MA_infl_q2$coef[1],col="green")
abline(v=outputmcmcAR_CPIAUCSL$mean$theta_1,col="blue")

theta.mcmc.mat=as.matrix(outputmcmcAR_CPIAUCSL$samples[,c("theta_2")], iters = FALSE)
ytheta=kdensity(theta.mcmc.mat)
plot(ytheta,main="posterior of theta 2")
abline(v=MA_infl_q2$coef[2],col="green")
abline(v=outputmcmcAR_CPIAUCSL$mean$theta_2,col="blue")
```